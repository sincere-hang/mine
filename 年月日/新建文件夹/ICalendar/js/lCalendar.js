	...
	MobileCalendar.prototype = {
		...
		bindEvent: function(type) {
			...
			function finishMobileDate(e) {
				...
				var finishMobileDate1 = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd;

				closeMobileCalendar(e);
				console.log(finishMobileDate1);
			}
			//日期时间确认
			function finishMobileDateTime(e) {
				...
				var fininshTime = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd + " " + (time_hh.length < 2 ? "0" : "") + time_hh + (time_mm.length < 2 ? ":0" : ":") + time_mm;
				console.log(fininshTime);
				closeMobileCalendar(e);
			}
			//时间确认
			function finishMobileTime(e) {
				...
				var finishMobile = (time_hh.length < 2 ? "0" : "") + time_hh + (time_mm.length < 2 ? ":0" : ":") + time_mm+ (time_ss.length < 2 ? ":0" : ":") + time_ss;
				console.log(finishMobile)
				closeMobileCalendar(e);
			}
